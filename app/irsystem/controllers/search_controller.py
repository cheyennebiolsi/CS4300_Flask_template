...
class QuerySimilarityFactory:
    ...
    def buildQuerySimilarityIndex(self, animeTitles, words, wordQueryRepresentation):
        ...
        for index in range(len(animeTitles)):
            ...
            similarityJson["chart_legend_id_a"] = "chart-legend-sim-a" + str(index)
            similarityJson["chart_id_a"] = "sima" + str(index)
            similarityJson["chart_name_a"] = "chartnamesima" + str(index)
            similarityJson["collapse_id"] = "collapsesim" + str(index)
